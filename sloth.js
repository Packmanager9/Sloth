...
window.addEventListener('DOMContentLoaded', (event) =>{
    ...
    class Spring{
        ...
        balance(){
            ...
            if(this.anchor != pin2 && this.anchor != pin3 && this.anchor != pin4 ){
    ...
    window.setInterval(function(){ 
        ...
        if(pin.isPointInside(food)){
            score +=1 
            food = new Circle(Math.random()*700,Math.random()*700,5,"orange")
        }
        if(pin2.isPointInside(food)){
            score +=1 
            food = new Circle(Math.random()*700,Math.random()*700,5,"orange")
        }
        if(pin3.isPointInside(food)){
            score +=1 
            food = new Circle(Math.random()*700,Math.random()*700,5,"orange")
        }
        if(pin4.isPointInside(food)){
            score +=1 
            food = new Circle(Math.random()*700,Math.random()*700,5,"orange")
        }
        ...
        infooverlay_context.fillText(`${score}`, 15,15);
